...
const RULE_DOCS: Record<string, string> = {
  ...
  "missing-token-in-css": "Define the corresponding CSS variable in your token source (for example, in :root).",
  "token-value-mismatch": "Align CSS variable values with DESIGN.md token values.",
  "unused-css-token": "Remove unused CSS variables or define matching DESIGN.md tokens.",
